...
const ExpendituresList = () => {
  ...
  const navigatePage = (pageNumber) => {
    setPage(pageNumber);
    navigate(`/admin/expenditures?page=${pageNumber}`, { state: { page: pageNumber } });
  };
  ...
  return (
    ...
    {error && <Message variant="danger">{error.message}</Message>}
      ...
      <Link to="/admin/expenditures/post" className="post-expenditure-button">
        Post Expenditure
      </Link>
